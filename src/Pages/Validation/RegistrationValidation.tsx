...
function validation(values: FormValues): FormErrors {
  ...
  const firstnamePattern: RegExp = /^[A-Z][a-zA-Z0-9_-]{2,19}$/; // First letter is uppercase, and total length is between 3 and 20 characters
  const lastnamePattern: RegExp = /^[A-Z][a-zA-Z0-9_-]{2,19}$/; // First letter is uppercase, and total length is between 3 and 20 characters
  ...
  if (!values.firstname) {
    ...
    errors.firstname =
      "First_name must start with an uppercase letter, and can only contain letters, numbers, underscores, and hyphens";
  }
  ...
  if (!values.lastname) {
    ...
    errors.lastname =
      "Last_name must start with an uppercase letter, and can only contain letters, numbers, underscores, and hyphens";
  }
