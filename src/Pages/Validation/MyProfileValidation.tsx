...
// This is a validation file for my profile page. Check for firstname and lastname should start with a capital letter, no digits, no special character. Email should be in proper format like there is @ and . then phone number should contain only digits and have a maximum length of 10 digits then these all fields and state, city, country are required.
...
function validation(values: FormValues): Errors {
  ...
  const phonePattern: RegExp = /^\d{1,10}$/; // Updated phonePattern to allow 1 to 10 digits
  ...
  if (!values.firstName) {
    ...
    errors.firstName =
      "First name should start with a capital letter, no digits, and no special characters.";
  }
  ...
  if (!values.lastName) {
    ...
    errors.lastName =
      "Last name should start with a capital letter, no digits, and no special characters.";
  }
  ...
  if (!values.phoneNumber) {
    ...
    errors.phoneNumber =
      "Phone number should contain only digits and have a maximum length of 10 digits.";
  }
