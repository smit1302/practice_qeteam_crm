...
export default function Index() {
  ...
  // const profileReportRef = useRef(null)
  // const OrderStatisticsRef = useRef(null)
  // const incomeChartRef = useRef(null)
  // const weeklyExpensesRef= useRef(null)

  // const [totalRevenueChartInstance, setTotalRevenueChartInstance] = useState(null);
  // const [growthChartInstance, setGrowthChartInstance] = useState(null);
  // const [profileReportCharttInstance, setProfileReportCharttInstance] = useState(null);
  ...
  //     instance: totalRevenueChartInstance,
  //     setInstance: setTotalRevenueChartInstance,
  //     options: totalRevenueChartOptions,
  //   },
  //   {
  //     ref: growthChartRef,
  //     instance: growthChartInstance,
  //     setInstance: setGrowthChartInstance,
  //     options: growthChartOptions,
  //   },
  //   {
  //     ref: profileReportRef,
  //     instance: profileReportCharttInstance,
  //     setInstance: setProfileReportCharttInstance,
  //     options: profileReportChartOptions,
  //   },
  //   {
  //     ref: OrderStatisticsRef,
  //     instance: OrderStatisticsInstance,
  //     setInstance: setOrderStatisticsInstance,
  //     options: orderChartOptions,
  //   },
  //   {
  //     ref: incomeChartRef,
  //     instance: incomeChartInstance,
  //     setInstance: setIncomeChartInstance,
  //     options: incomeChartOptions,
  //   },
  //   {
  //     ref: weeklyExpensesRef,
  //     instance: weeklyExpensesInstance,
  //     setInstance: setWeeklyExpensesInstance,
