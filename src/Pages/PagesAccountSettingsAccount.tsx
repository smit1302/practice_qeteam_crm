                  ...
                  <div className="col-md-12">
                    <ul className="nav nav-pills flex-column flex-md-row mb-3">
                      ...
                      <li className="nav-item">
                        ...
                        ><i className="bx bx-bell me-1"></i> Notifications</Link>
                      </li>
                      <li className="nav-item">
                        <Link to='/settings-connections' className="nav-link"
                        ><i className="bx bx-link-alt me-1"></i> Connections</Link>
                      </li>
                    </ul>
                    <div className="card mb-4">
                      ...
                      <hr className="my-0" />
                      <div className="card-body">
                        <form id="formAccountSettings" method="POST" onSubmit={(event) => {
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <form id="formAccountDeactivation" onSubmit={(event) => {
                          event.preventDefault(); // Prevents the default form submission behavior
                        }}>
